...
import { MdOutlineClose, MdOutlineKeyboardArrowRight, MdOutlineCheck } from "react-icons/md"
...
function PoperMenuNew({
    ...
    return createPortal(
        <div
            ...
            className="fixed top-0 left-0 right-0 bottom-0 z-50 bg-hoverBg"
            ref={popupContainerRef}
            // onClick={handleBack}
        >
            <Card className="fixed p-[0.5%] bg-neutron-4" style={{ ...position, width, minWidth: "500px" }}>
                <div className="flex items-center">
                    <h2 className="text-primary-1 w-full text-center">{currentNavItem.title}</h2>
                    <Button small transparent onClick={handleBack} className="ml-auto">
